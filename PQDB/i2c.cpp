...
// Envia um bit um(1)
void set_SDA(void) {
  // o bit um é feito colocando o terminal como entrada e permitindo que o
  // pull-up leve o terminal para 1
  pinMode(SDA_PIN, INPUT);
}
...
void i2c_start(void) {
  if (started) {  // se já estiver iniciado, prepara para reenviar o bit de
                  // start
    set_SDA();
    I2C_delay();
